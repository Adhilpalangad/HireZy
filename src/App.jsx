        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16 items-center">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link to="/" className="text-gray-600 hover:text-primary-600 font-medium transition-colors">Find Jobs</Link>
              <Link to="#" className="text-gray-600 hover:text-primary-600 font-medium transition-colors">Companies</Link>
              <Link to="/login" className="text-gray-600 hover:text-primary-600 font-medium transition-colors">Login</Link>
              <Link to="/signup" className="text-gray-600 hover:text-primary-600 font-medium transition-colors">Sign Up</Link>
            </div>
